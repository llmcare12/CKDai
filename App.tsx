    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <Link to="/summary" className="group">
        <div className="aspect-square md:aspect-auto bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300 h-full hover:-translate-y-1">
          ...
          <h3 className="text-2xl md:text-lg font-bold text-gray-800 mb-2">AI 重點摘要</h3>
          <p className="text-lg md:text-base text-gray-600">透過對話，即時獲得淺顯易懂的衛教解答。</p>
        </div>
      </Link>
      ...
      <Link to="/podcast" className="group">
        <div className="aspect-square md:aspect-auto bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300 h-full hover:-translate-y-1">
          ...
          <h3 className="text-2xl md:text-lg font-bold text-gray-800 mb-2">衛教 Podcast</h3>
          <p className="text-xl md:text-base text-gray-600">輸入主題，生成專屬語音導覽，用聽的學習。</p>
        </div>
      </Link>
      ...
      <Link to="/mindmap" className="group">
        <div className="aspect-square md:aspect-auto bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300 h-full hover:-translate-y-1">
          ...
          <h3 className="text-2xl md:text-lg font-bold text-gray-800 mb-2">知識心智圖</h3>
          <p className="text-xl md:text-base text-gray-600">視覺化知識結構，快速掌握複雜概念。</p>
        </div>
      </Link>
      ...
      <Link to="/qna" className="group">
        <div className="aspect-square md:aspect-auto bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300 h-full hover:-translate-y-1">
          ...
          <h3 className="text-2xl md:text-lg font-bold text-gray-800 mb-2">腎臟病Q&A</h3>
          <p className="text-xl md:text-base text-gray-600">彙整病患最常見的15個問題</p>
        </div>
      </Link>
